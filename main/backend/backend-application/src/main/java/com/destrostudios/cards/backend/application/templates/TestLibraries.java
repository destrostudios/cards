...
public class TestLibraries {
    ...
    public static CardPool red() {
        ...
        cards.put((data) -> EntityTemplate.createFromTemplate(data, "creatures/goblin"), 3);
        ...
        cards.put((data) -> EntityTemplate.createFromTemplate(data, "creatures/novice_engineer"), 3);
