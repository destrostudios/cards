...
public class Components {
    ...
    public static final ComponentDefinition<int[]> DAMAGE_TRIGGERS = createComponent("damageTriggers");
    public static final ComponentDefinition<int[]> HEAL_TRIGGERS = createComponent("healTriggers");
