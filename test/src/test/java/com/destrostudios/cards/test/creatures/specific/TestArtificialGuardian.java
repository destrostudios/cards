...
public class TestArtificialGuardian extends TestGame {
    ...
    public void testBuffWhenOnBoard() {
        int card1 = create("creatures/artificial_guardian", player, Components.CREATURE_ZONE);
        assertAttack(card1, 2);
        assertHealth(card1, 1);
        int card2 = create("creatures/artificial_guardian", player, Components.CREATURE_ZONE);
